...
function showError() {
    if (articleArrows) {
        addContentAfter("p", "Something went wrong, please refresh the page", "error-message", articleArrows);
    }
}
function hideLoader() {
...
function addCarouselItem({ name, imgSource, commonName, description, }) {
    const htmlContent = `
...
function AnimalData() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            showLoader();
            const { data } = yield fetchData("https://vsqsnqnxkh.execute-api.eu-central-1.amazonaws.com/prod/pets");
            if (data.length > 0 && articleArrows) {
                carouselContainer = createElement("div", "carousel-container");
                data.forEach((animal) => {
                    const animalItem = addCarouselItem(Object.assign(Object.assign({}, animal), { imgSource: "../../assets/images/carousel-images/panda.png" }));
