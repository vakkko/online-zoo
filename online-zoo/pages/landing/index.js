...
import { fetchData, showLoader, showError, hideLoader, } from "../../utils/fetch/fetch.js";
...
const articleArrows = document.querySelector(".article-arrows");
const feedbacksArrowBox = document.querySelector(".arrows-box.feedback");
function carouselItem({ name, imgSource, commonName, description, }) {
    const htmlContent = `
...
function renderCarouselItems() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            showLoader(articleArrows, "after");
            ...
            if (data.length > 0 && articleArrows) {
                ...
                data.forEach((animal) => {
                    const animalItem = carouselItem(Object.assign(Object.assign({}, animal), { imgSource: "../../assets/images/carousel-images/panda.png" }));
                    carouselContainer.insertAdjacentHTML("beforeend", animalItem);
                });
                articleArrows === null || articleArrows === void 0 ? void 0 : articleArrows.after(carouselContainer);
            }
        }
        catch (error) {
            showError(articleArrows, "after");
        }
        finally {
            hideLoader();
        }
...
renderCarouselItems();
function feedbackItem({ city, month, year, text, name }) {
    const htmlContent = `
     <section>
              <img src="../../assets/images/quote.png" alt="quote" />
              <h4>${city}, ${month} ${year}</h4>
              <p>
                ${text}
              </p>
              <span>${name}</span>
...
function renderFeedbacks() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            showLoader(feedbacksArrowBox, "before");
            feedbackCarousel = createElement("div", "feedback-carousel");
            const { data } = yield fetchData(`${BASE_URL}/feedback`);
            if (data.length > 0 && feedbackCarousel instanceof HTMLElement) {
                data.forEach((feedback) => {
                    const feedbackItems = feedbackItem(Object.assign({}, feedback));
                    feedbackCarousel === null || feedbackCarousel === void 0 ? void 0 : feedbackCarousel.insertAdjacentHTML("beforeend", feedbackItems);
                });
                feedbacksArrowBox === null || feedbacksArrowBox === void 0 ? void 0 : feedbacksArrowBox.before(feedbackCarousel);
            }
        }
        catch (error) {
            showError(feedbacksArrowBox, "before");
        }
        finally {
            hideLoader();
        }
...
rightSliderAnimal === null || rightSliderAnimal === void 0 ? void 0 : rightSliderAnimal.addEventListener("click", () => {
    slideRight(carouselContainer);
});
leftSliderFeedback === null || leftSliderFeedback === void 0 ? void 0 : leftSliderFeedback.addEventListener("click", () => {
    slideLeft(feedbackCarousel);
});
rightSliderFeedback === null || rightSliderFeedback === void 0 ? void 0 : rightSliderFeedback.addEventListener("click", () => {
    slideRight(feedbackCarousel);
});
